...
export default function AboutUs() {
  const aboutData = {
    title: 'About Us',
    subtitle:
      'Building the future of Legal literacy and put a stop in social exploitation.',
    mission:
      'Our mission is to democratize legal literacy by providing highly reliable information based on Indian Legal context that help individuals understand the situation and legal practitioners perform research quickly and efficiently.',
    vision:
      'We envision a world where answer to the legal queries accessible to everyone, regardless of their background or prior knowledge.',
